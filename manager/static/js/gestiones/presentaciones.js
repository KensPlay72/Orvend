  ...
  document.querySelectorAll(".btn-edit").forEach((button) => {
    button.addEventListener("click", async () => {
      ...
      if (data.success) {
        ...
        document.getElementById("npresentacionedit").value =
          presentacion.nombre;
        document.getElementById("abreviaturaedit").value =
          presentacion.abreviatura;
        document.getElementById("valoredit").value = presentacion.valor;
        ...
        Swal.fire(
          "Error",
          data.message || "No se pudo obtener la informacion",
          "error",
        );
      }
    });
      ...
      if (result.isConfirmed) {
        try {
          const response = await fetch(
            `/manager/presentaciones/delete/${id}/`,
            {
              method: "DELETE",
              headers: {
