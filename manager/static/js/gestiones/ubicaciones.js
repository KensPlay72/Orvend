...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const payload ={
        Nombre: document.getElementById("nubicacion").value,
        Tipo: document.getElementById("tubicacion").value,
        Codigo: document.getElementById("cubicacion").value,
    }
    ...
    document.querySelectorAll(".btn-edit").forEach(button => {
        button.addEventListener("click", async () => {
            ...
            if (data.success){
                ...
                document.getElementById("nubicacionedit").value = ubicacion.nombre;
                document.getElementById("tubicacionedit").value = ubicacion.tipo;
                document.getElementById("cubicacionedit").value = ubicacion.codigo;
...
document.getElementById("putregistro").addEventListener("submit", async (e) => {
    ...
    const payload ={
        ...
        Tipo: document.getElementById("tubicacionedit").value,
